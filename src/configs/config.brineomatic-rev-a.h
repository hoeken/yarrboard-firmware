...
#define YB_DC_MOTOR_CHANNEL_COUNT 2
#define YB_DC_MOTOR_A_PINS        {41}
#define YB_DC_MOTOR_B_PINS        {42}

#define YB_HAS_DS18B20_CHANNEL
#define YB_DS18B20_CHANNEL_COUNT 1
#define YB_DS18B20_PINS          {6}

#define YB_ADC_DRIVER_ADS1115
#define YB_ADS1115_VREF       3.3
#define YB_ADS1115_ADDRESS    0x48
