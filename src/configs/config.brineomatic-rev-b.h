...
#define YB_HAS_STEPPER_MOTOR
#define YB_STEPPER_DRIVER_TMC2209
#define YB_STEPPER_STEP_PIN   7
#define YB_STEPPER_DIR_PIN    6
#define YB_STEPPER_ENABLE_PIN 11
#define YB_STEPPER_DIAG_PIN   8
#define YB_STEPPER_TX_PIN     10
#define YB_STEPPER_RX_PIN     9
