...
#define YB_HARDWARE_URL     "https://github.com/hoeken/sendit/releases/tag/Rev-A"
...
#define YB_ADC_VREF                      ADS1x15_GAIN_4096MV_FSRANGE_V
#define YB_ADC_GAIN                      ADS1X15_GAIN_4096MV
